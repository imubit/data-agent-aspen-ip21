...
Welcome to `data-agent-aspen-ip21` contributor's guide.
...
If you experience bugs or general issues with `data-agent-aspen-ip21`, please have a look
...
You can help improve `data-agent-aspen-ip21` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`data-agent-aspen-ip21` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `data-agent-aspen-ip21`'s files. While this mechanism can
...
```
conda create -n data-agent-aspen-ip21 python=3 six virtualenv pytest pytest-cov
conda activate data-agent-aspen-ip21
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/data-agent-aspen-ip21.git
   cd data-agent-aspen-ip21
   ```
...
5. Install [pre-commit]:
   ...
   `data-agent-aspen-ip21` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/data-agent-aspen-ip21
[issue tracker]: https://github.com/<USERNAME>/data-agent-aspen-ip21/issues
